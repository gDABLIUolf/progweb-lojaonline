...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 2. Inicializar Produtos adaptado para N:N
        if (produtoRepository.count() == 0) {
            Produto p1 = new Produto("T-Shirt Algodão Pima Branca",
                    ...
                    new BigDecimal("149.00"), 100);
            p1.setCategorias(List.of(basicos)); // Passando como Lista
            ...
            Produto p2 = new Produto("Suéter Tricot Cinza Claro",
                    ...
                    new BigDecimal("359.00"), 50);
            p2.setCategorias(List.of(malhas, basicos)); // Exemplo perfeito de Múltiplas Categorias!
            ...
            Produto p3 = new Produto("Calça Chino Classic Areia",
                    ...
                    new BigDecimal("289.00"), 80);
            p3.setCategorias(List.of(bottoms));
