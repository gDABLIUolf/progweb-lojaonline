...
.btn-filtro {
  background: var(--surface-color, #f1f3f5);
  border: none;
  border-radius: 20px;
  padding: 8px 16px;
  font-weight: 500;
...
.btn-filtro:hover {
  background: var(--surface-light, #e9ecef);
...
.item-ofuscado::after {
  ...
  background: linear-gradient(
    to bottom,
    transparent 0%,
    var(--surface-light, rgba(248, 249, 250, 0.7)) 50%,
    var(--surface-light, rgba(248, 249, 250, 1)) 100%
  );
  pointer-events: none;
  z-index: 2;
}
